...
<head>
    ...
    <link rel="stylesheet" href="<?= ASSETS_URL . "/styles/style_hotels.css" ?>">
    <title>Hotels in the city</title>
</head>
<body>
    ...
    <header>
        ...
        <div class="content">
            <div class="naslovv">
                <div class="title">
                    <h1 id="naslov">The 5 best Hotels in</h1>
                    <h1 class="grad"> <?= $hotels[0]["city"] ?>!</h1>
                </div>
                 
                <p id="poruka">Find the perfect place to stay, only with Traveler.</p>
            </div>
            <?php foreach ($hotels as $hot): ?>
            <div class="card">
                    <div class="picture">
                        <img src="<?= ASSETS_URL . "hotels/" . $hot["pic"] ?>" alt="hotel" class="pic">
                    </div>
                    <div class="text">
                        <div class="ime_hotela">
                             <h1 class="ime"><?= $hot["nm"] ?></h1>
                        </div>
                        <div class="opis">
                            <div class="lokacija">
                                <h2>Location</h2>
                        ...
                        <div class="pogled">
                                <h3><a href="<?= BASE_URL . "hotels/detail?id=" . $hot["id"] ?>" class="gledaj">View deal</a></h3>
                        </div>
                    </div>
            </div>    
            <?php endforeach; ?>
